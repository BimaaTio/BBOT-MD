...
async function startBBOT() {
    ...
    const conn = connConnect({
        ...
        browser: ['BBOT Multi Device','Safari','1.0.0'],
   ...
   // anticall auto block
    ...
    conn.ev.on('messages.upsert', async chatUpdate => {
        ...
        require("./bbot")(conn, m, chatUpdate, store)
        } catch (err) {
            console.log(err)
        }
    })
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await conn.getName(i + '@s.whatsapp.net')}\nFN:${await conn.getName(i + '@s.whatsapp.net')}\nitem1.TEL;waid=${nomerowner}:${nomerowner}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:bimaatio10@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://bimaatio.github.io\nitem3.X-ABLabel:Bimatio\nitem4.ADR:;;Indonesia;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
